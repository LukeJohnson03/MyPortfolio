  ...
  <section id="skills" className="bg-zinc-900 py-16">
    <div className="mx-auto max-w-4xl text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        {/* List your skills */}
        <div className="group relative w-28 h-28 bg-gray-700 rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-105">
  <img
    src="https://via.placeholder.com/150" 
    alt="JavaScript"
    className="w-full h-2/3 object-cover"
  />
  <div className="absolute bottom-0 w-full h-1/3 bg-gray-800 flex items-center justify-center">
